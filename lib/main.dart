...
import 'package:yi/pages/Landing.dart';
...
Map<String, ProductDetails> categoryProductMap = new Map();
Map<String, CartProduct> cartProductMap = new Map();
...
bool allCategoryProductsAvailable = false;
String productsFirebaseNode = 'stores/KIRANAWALA_STORE_2/products';

double totalSaleForDate;
double totalSaleForMonth;
double totalSaleForYear;

int totalWalkinsForDate;
int totalWalkinsForMonth;
int totalWalkinsForYear;

int categoriesSoldForDate;
int categoriesSoldForMonth;
int categoriesSoldForYear;

int productsSoldForDate;
int productsSoldForMonth;
int productsSoldForYear;
...
String deliveryOption = deliveryOptions[0];
String deliverySlot = 'N/A';
...
var homePageCategories = [
  ...
  },
  {
    ...
    // 'https://firebasestorage.googleapis.com/v0/b/oshop-21421.appspot.com/o/homecategorybanners%2Fbatteries.jpg?alt=media&token=c70d3b25-7594-4656-a477-e54b22c9f389'
  },
  {
...
void main() {
  int categoryCount = homePageCategories.length;
  print('main.dart: TOTAL NO.OF CATEGORIES:' + categoryCount.toString());
  ...
  homePageCategories.forEach((f) {
    categoryProductsAvailable[f['categoryName']] = false;
  });

  homePageCategories.forEach((f) {
    String category = f['categoryName'];
    //print(category);
        ...
        values.forEach((dynamic key, dynamic values) {
          if (values['productcode'].runtimeType.toString() == 'String') {
            ...
            if (values['price'].runtimeType.toString() == 'String') {
              ...
              productMap[values['productcode'].toString()] = new ProductDetails(
                  values['title'],
                  double.parse(values['price']),
                  values['productcode'].toString(),
                  values['barcode'],
